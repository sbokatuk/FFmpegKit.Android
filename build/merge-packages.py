...
No single .NET SDK can build net8.0-android, net9.0-android and net10.0-android together: each
SDK's Android workload supports only the current TFM and the previous one. The packages are
therefore built in two passes (see BuildNugets.sh) and merged here into one package per variant.
